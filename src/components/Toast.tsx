...
const ToastItem: React.FC<ToastItemProps> = ({ toast }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = 'border-l-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg';
  ...
  return (
    <motion.div
      ...
      className={`${getToastStyles()} rounded-lg p-4 cursor-pointer`}
